  ...
  return (
    <div className="relative max-w-sm">
      <input
        ...
        className="w-[255px] h-[50px] text-[#232323] py-2 pl-12 pr-4 border border-[#F5F7FA] bg-[#F5F7FA] rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-[#8BA3CB]"
